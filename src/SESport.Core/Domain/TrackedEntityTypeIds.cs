...
public static class TrackedEntityTypeIds
{
   ...
   public const string Series = nameof(TrackedEntityType.Series);
   public const string Tour = nameof(TrackedEntityType.Tour);
   public const string League = nameof(TrackedEntityType.League);
   public const string Championship = nameof(TrackedEntityType.Championship);
